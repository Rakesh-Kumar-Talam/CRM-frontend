...
router.get('/google/callback', (req: Request, res: Response) => {
  try {
    ...
    if (error) {
      ...
      const frontendUrl = process.env.FRONTEND_URL || 'https://crm-frontend-xqgx.onrender.com';
    ...
    passport.authenticate('google', { session: false }, (err: any, user: any, info: any) => {
      ...
      try {
        ...
        const redirectUrl = req.session?.redirectUrl || process.env.FRONTEND_URL || 'https://crm-frontend-xqgx.onrender.com';
        ...
        // Redirect to frontend with token - redirect to root path (dashboard)
